...
public class ImportantHistoryOfPatientFragment extends Fragment
{
                    ...
                    try {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            ...
                            if(jsonObject.getString("Flag").equals("true"))
                            {
                                ...
                                items.add(item);
                                db.insert(jsonObject.getString("transactionId"),Data.PATIENT_ID,jsonObject.getString("StaffName"),jsonObject.getString("Address"),jsonObject.getString("ChronicDisease"),jsonObject.getString("Disease"),jsonObject.getString("DiseaseType"),jsonObject.getString("DiseaseCategory"),jsonObject.getString("DiseaseSubCategory"),jsonObject.getString("allergies"),jsonObject.getString("AlcoholConsumption"),jsonObject.getString("SmokingHabits"),jsonObject.getString("medicines"),jsonObject.getString("tests"),jsonObject.getString("Date"),jsonObject.getString("claimStatus"),jsonObject.getString("HospitalName"));
                            }
                        }
                    }
                    catch (Exception e)
    ...
    public void onResume()
    {
        super.onResume();
        getData();
        history_of_patient_rv.invalidate();
    }
